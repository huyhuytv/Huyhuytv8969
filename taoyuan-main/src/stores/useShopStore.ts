...
export const useShopStore = defineStore('shop', () => {
  ...
  const blacksmithItems = computed<ShopItemEntry[]>(() => [
    { itemId: 'copper_ore', name: tText('mỏ đồng', 'mỏ đồng'), price: 100, description: tText('Quặng đồng thông thường trong mỏ', 'Quặng đồng thông thường trong mỏ') },
    { itemId: 'iron_ore', name: tText('quặng sắt', 'quặng sắt'), price: 200, description: tText('Quặng sắt được sản xuất ở mỏ giữa', 'Quặng sắt được sản xuất ở mỏ giữa') },
    { itemId: 'gold_ore', name: tText('mỏ vàng', 'mỏ vàng'), price: 400, description: tText('Tiền gửi vàng từ mỏ sâu', 'Tiền gửi vàng từ mỏ sâu') },
    { itemId: 'copper_bar', name: tText('thỏi đồng', 'thỏi đồng'), price: 300, description: tText('Thỏi đồng nấu chảy', 'Thỏi đồng nấu chảy') },
    { itemId: 'iron_bar', name: tText('phôi sắt', 'phôi sắt'), price: 600, description: tText('Thỏi sắt nấu chảy', 'Thỏi sắt nấu chảy') },
    { itemId: 'gold_bar', name: tText('thỏi vàng', 'thỏi vàng'), price: 1200, description: tText('Thỏi vàng nấu chảy', 'Thỏi vàng nấu chảy') },
    { itemId: 'charcoal', name: tText('than củi', 'than'), price: 100, description: tText('than củi', 'than củi') }
  ])
  ...
  const apothecaryItems = computed<ShopItemEntry[]>(() => [
    { itemId: 'herb', name: tText('thuốc thảo dược', 'thuốc thảo dược'), price: 50, description: tText('Thảo dược hoang dã trên núi', 'Thảo dược hoang dã trên núi') },
    { itemId: 'ginseng', name: tText('nhân sâm', 'Nhân sâm'), price: 600, description: tText('Nhân sâm rừng cực quý hiếm', 'Nhân sâm rừng cực quý hiếm') },
    { itemId: 'animal_medicine', name: tText('thuốc thú y', 'thuốc thú y'), price: 150, description: tText('Chữa trị gia súc bị bệnh', 'Chữa trị gia súc bị bệnh') },
    { itemId: 'premium_feed', name: tText('Thức ăn đậm đặc', 'Thức ăn đậm đặc'), price: 200, description: tText('Cải thiện tâm trạng và thiện chí của động vật', 'Cải thiện tâm trạng và thiện chí của động vật') },
    { itemId: 'nourishing_feed', name: tText('thức ăn bổ dưỡng', 'thức ăn bổ dưỡng'), price: 250, description: tText('Tăng tốc sản lượng chăn nuôi', 'Tăng tốc sản lượng chăn nuôi') },
    { itemId: 'vitality_feed', name: tText('Thức ăn sinh lực', 'Thức ăn sinh lực'), price: 300, description: tText('Ăn chắc chắn sẽ khỏi bệnh', 'Ăn chắc chắn sẽ khỏi bệnh') },
    { itemId: 'fish_feed', name: tText('thức ăn cho cá', 'thức ăn cho cá'), price: 30, description: tText('Thức ăn đặc biệt cho ao nuôi cá', 'Thức ăn đặc biệt cho ao nuôi cá') },
    { itemId: 'water_purifier', name: tText('chất cải thiện chất lượng nước', 'chất cải thiện chất lượng nước'), price: 100, description: tText('Cải thiện chất lượng nước ao cá', 'Cải thiện chất lượng nước ao cá') }
  ])
  ...
  const fishingShopItems = computed<ShopItemEntry[]>(() => [
    { itemId: 'crab_pot', name: tText('Nồi cua', 'Nồi cua'), price: 1500, description: tText('Đặt nó ở vị trí câu cá và tự động bắt thủy sản mỗi ngày (cần có mồi)', 'Đặt nó ở vị trí câu cá và tự động bắt thủy sản mỗi ngày (cần có mồi)') }
  ])

  // === 绸缎庄 (素素) ===

  const textileItems = computed<ShopItemEntry[]>(() => [
    { itemId: 'cloth', name: tText('vải', 'vải'), price: 1200, description: tText('vải dệt từ len', 'vải dệt từ len') },
    { itemId: 'silk_cloth', name: tText('lụa', 'lụa'), price: 500, description: tText('lụa tuyệt đẹp', 'lụa tuyệt đẹp') },
    { itemId: 'alpaca_cloth', name: tText('len alpaca', 'len alpaca'), price: 900, description: tText('Lông cừu alpaca cực kỳ mềm mại', 'Lông cừu alpaca cực kỳ mềm mại') },
    { itemId: 'felt', name: tText('nỉ', 'Cảm thấy'), price: 600, description: tText('Nỉ ép từ lông thỏ', 'Nỉ ép từ lông thỏ') },
    { itemId: 'silk_ribbon', name: tText('Khăn lụa', 'Khăn lụa'), price: 500, description: tText('Khăn lụa được thêu tỉ mỉ', 'Khăn lụa được thêu tỉ mỉ') },
    { itemId: 'jade_ring', name: tText('nhẫn ngọc lục bảo', 'nhẫn ngọc lục bảo'), price: 1500, description: tText('Có thể dùng để cầu hôn', 'Có thể dùng để cầu hôn') },
    { itemId: 'zhiji_jade', name: tText('Mặt dây chuyền ngọc bích đáng tin cậy', 'Mặt dây chuyền ngọc bích đáng tin cậy'), price: 1500, description: tText('Tặng nó cho người bạn thân cùng giới để trở thành người bạn tâm giao', 'Tặng nó cho người bạn thân cùng giới để trở thành người bạn tâm giao') },
    { itemId: 'pine_incense', name: tText('nhựa thông', 'nhựa thông'), price: 250, description: tText('mùi thông tươi', 'mùi thông tươi') },
    { itemId: 'camphor_incense', name: tText('Hương thơm long não', 'Hương thơm long não'), price: 400, description: tText('Làm mới và làm mới', 'Làm mới và làm mới') },
    { itemId: 'osmanthus_incense', name: tText('Hương thơm Osmanthus', 'Hương thơm Osmanthus'), price: 800, description: tText('Hương thơm hoa mộc tê thơm', 'Hương thơm hoa mộc tê thơm') }
  ])
