...
const G1_PREFIXES = ['Bạc', 'Vàng', 'Đỏ', 'Hoa', 'Mặc', 'Phỉ', 'Nguyệt', 'Sương', 'Tinh', 'Vân', 'Ngọc', 'Bích', 'Tuyết', 'Phi', 'Diễm', 'Lam']
const G2_PREFIXES = ['Linh', 'Tiên', 'Dao', 'Huyễn', 'Mộng', 'Thần', 'Thánh', 'Thiên']
const G3_PREFIXES = ['Quỳnh Quang', 'Dao Hoa', 'Linh Cảnh', 'Tiên Vực']
const G4_PREFIXES = ['Thái Cổ', 'Hồng Mông', 'Hỗn Độn']
const G5_PREFIXES = ['Hóa Long', 'Dục Hỏa']
